...
echo "${green}delete all signal-be pm2 processes${reset}"
pm2 delete signal
...
pm2 start build/index.js --node-args="--max-old-space-size=8096" -i max --name="signal" --log-date-format="DD-MM-YYYY HH:mm Z" -f -- 446
